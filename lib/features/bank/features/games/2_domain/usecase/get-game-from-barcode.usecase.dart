...
class GetGamesFromBarcodeUsecase implements Usecase<Either<String, List<GameEntity>>, SearchGamesRequest?> {
  @override
  Future<Either<String, List<GameEntity>>> execute({
    SearchGamesRequest? request,
  }) async {
    return serviceLocator<GamesRepository>().getGames(request);
  }
}
